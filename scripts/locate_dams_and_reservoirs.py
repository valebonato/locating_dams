...
cmd = "col2map --clone " + clone_map_file + " -M -x 4 -y 3 -v 1 " + column_input_file + "dam_ids.map" 
...
cmd = "col2map --clone " + clone_map_file + " -M -x 4 -y 3 -v 2 " + column_input_file + "aha_catchment_area_km2.map"
print(cmd); os.system(cmd)
